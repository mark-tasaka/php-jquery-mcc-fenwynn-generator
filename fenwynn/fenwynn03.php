...
<html>
<head>
<title>Iconic NPC Fenwynn Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_fenwynn.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_fenwynn_post.css">
    ...
    <script type="text/javascript" src="./js/plantientEquipment.js"></script>
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
    ...
    <span id="additionalLanguages"></span>
       ...
       <span id="zeroLevelMutantAppearance">Mosses: Liverwort</span>
  ...
  <script>
	...
	*/
    ...
    let genotypeTongue = getDialectTonue(intelligence);
    let plantient = getFenwynn();
		
		let plantientCharacter = {
			"name": "Fenwynn",
			"strength": strength,
			"agility": agility,
			"stamina": stamina,
            ...
            "level": plantient.level,
            "title": plantient.title,
			"hitPoints": hitPoints (plantient, staminaModifier, hitPointAdjustPerLevel(luckySign, luckModifier)),
			"ref": plantient.ref + agilityModifier + adjustRef(birthAugur, luckModifier),
			"fort": plantient.fort + staminaModifier + adjustFort(birthAugur,luckModifier),
			"will": plantient.will + personalityModifier + adjustWill(birthAugur, luckModifier),
            "init": agilityModifier,
			"melee": plantient.attackBonus + strengthModifier + meleeAdjust(birthAugur, getLuckModifier(luck)),
			...
			"critDie": plantient.critDie + "" + addSign(plantient.critBonus + adjustCrit(birthAugur, getLuckModifier(luck))),
			"critTable": plantient.critTable,
            "actionDice": plantient.actionDice,
            "artifactCheck": "1d20" + "" + addSign(intelligenceModifier + plantient.artifactCheckBonus),
            "techLevel": maxTechLevel,
            "languages": "Nu-Speak" + genotypeTongue, 
	    ...
	    if(plantientCharacter.hitPoints <= 0 ){
			plantientCharacter.hitPoints = 1;
		}
		return plantientCharacter;
	  
	  }
	  
    /*getFenwynn() return the statistics for the Manimal per level*/  
    function getFenwynn() {
	let plantient = [
	...
	return plantient[2];  
       ...
       let imgData = "images/fenwynn_character_sheet.png";
