...
<html>
<head>
<title>Launch Page: Fenwynn Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
		<form action="" id ="fenwynnForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Fenwynn, Level 1</option>
				<option value="02">Fenwynn, Level 2</option>
				<option value="03">Fenwynn, Level 3</option>
				<option value="04">Fenwynn, Level 4</option>
				<option value="05">Fenwynn, Level 5</option>
				<option value="06">Fenwynn, Level 6</option>
				<option value="07">Fenwynn, Level 7</option>
				<option value="08">Fenwynn, Level 8</option>
				<option value="09">Fenwynn, Level 9</option>
				<option value="10">Fenwynn, Level 10</option>
			  </select>
        ...
        {
            $("#fenwynnForm").attr('action', "fenwynn/fenwynn"+ $("#level").val() +  ".php");
        });
